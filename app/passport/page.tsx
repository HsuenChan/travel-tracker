...
import {
  teaserPlacement, centrePlacement, readFlag, writeFlag, readSpan,
  ENTER_KEY, RETURN_KEY, type Placement,
...
export default function PassportPage() {
  ...
  */
  ...
  }, [leaving, closing, use3D, startFly]);
  ...
  */
  return (
    ...
    <div className="relative h-[100dvh] bg-[#09090b] flex flex-col overflow-hidden">
      {/*
