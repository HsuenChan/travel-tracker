...
import { PlaneIcon, PhotoIcon, CalendarIcon, CoinIcon, NotepadIcon, LocationIcon, GiftIcon, CarabinerIcon } from "@/app/components/Icons";
...
const ALL_TABS = [
  ...
  { key: "gear", label: "裝備", icon: <CarabinerIcon size={14} /> },
];
