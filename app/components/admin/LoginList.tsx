...
export default function LoginList() {
  ...
  return (
    <div className="pt-6">
      <h1 className="text-[13px] font-bold uppercase tracking-[0.14em] text-zinc-500">登入紀錄</h1>
      <p className="mt-1.5 text-[13px] leading-relaxed text-zinc-500">
        每一次登入、登出與失敗的嘗試。點開可以看 IP 與完整的裝置字串。
      </p>
      ...
      <div className="mt-5">
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-white/[0.08] px-5 py-10 text-center">
            <p className="text-[15px] font-semibold text-zinc-300">還沒有登入紀錄</p>
            <p className="mt-1.5 text-[13px] leading-relaxed text-zinc-500">
              紀錄從這支功能上線後開始累積，下次登入就會出現在這裡。
            </p>
          </div>
        ) : (
          <>
